...
# Load Wine data set
df = pd.read_csv(r"C:\Users\Meghna\Documents\Python Scripts\DBSCAN\DBSCAN\wine_data.csv")
import pymysql
...
sql = 'select * from wine_tbl;'
wine_df = pd.read_sql_query(sql, engine)
...
my_report.show_html('wineReport.html')
